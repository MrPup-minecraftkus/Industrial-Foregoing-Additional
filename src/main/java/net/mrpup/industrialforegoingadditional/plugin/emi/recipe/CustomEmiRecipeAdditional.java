...
public abstract class CustomEmiRecipeAdditional implements EmiRecipe {
    private final ResourceLocation id;
    private final List<EmiIngredient> ingredients;
    private final EmiRecipeCategory category;
    private final List<EmiStack> output;

    protected CustomEmiRecipeAdditional(ResourceLocation id, EmiRecipeCategory category, List<EmiIngredient> ingredients, List<EmiStack> output) {
        this.id = id;
    ...
    public static List<EmiStack> fromOutput(ItemStack output, FluidStack fluidStack) {
        ...
        list.add(EmiStack.of(fluidStack.getFluid(), fluidStack.getComponentsPatch(), (long)fluidStack.getAmount()));
        return list;
    }
