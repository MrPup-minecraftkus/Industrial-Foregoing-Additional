...
public class JEICustomPluginAdditional implements IModPlugin {
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        registration.addGhostIngredientHandler(GuiConveyor.class, new IGhostIngredientHandler<GuiConveyor>() {
            public <I> List<Target<I>> getTargetsTyped(GuiConveyor guiConveyor, ITypedIngredient<I> i, boolean b) {
                return i.getIngredient() instanceof ItemStack ? (List)guiConveyor.getGhostSlots().stream().map((ghostSlot) -> new Target<I>() {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(ModuleCoreAdditional.FACTORY_CONSTRUCTOR.getKey().get()), new mezz.jei.api.recipe.RecipeType[]{IndustrialRecipeTypesAdditional.FACTORY_CONSTRUCTOR});
        registration.addRecipeCatalyst(new ItemStack(ModuleCoreAdditional.UPGRADED_CONSTRUCTOR.getKey().get()), new mezz.jei.api.recipe.RecipeType[]{IndustrialRecipeTypesAdditional.UPGRADED_CONSTRUCTOR});
        registration.addRecipeCatalyst(new ItemStack(ModuleCoreAdditional.POLISHING_MACHINE.getKey().get()), new mezz.jei.api.recipe.RecipeType[]{IndustrialRecipeTypesAdditional.POLISHING_MACHINE});
        registration.addRecipeCatalyst(new ItemStack(ModuleCoreAdditional.SOLIDIFIER.getKey().get()), new mezz.jei.api.recipe.RecipeType[]{IndustrialRecipeTypesAdditional.SOLIDIFIER});
