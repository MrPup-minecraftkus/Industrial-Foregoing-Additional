...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, IndustrialForegoingAdditional.MOD_ID);
    ...
    public static final RegistryObject<Block> ULTIMATE_MACHINE_FRAME = registerBlock("machine_frame_ultimate",
