...
public class SifterMachineTile extends IndustrialProcessingTile<SifterMachineTile> {
    private int maxProgress;
    private int powerPerTick;
    @Save
    private SidedInventoryComponent<SifterMachineTile> inputFirst;
    @Save
    private SidedInventoryComponent<SifterMachineTile> inputSecond;
    @Save
    private SidedFluidTankComponent<SifterMachineTile> inputFluid1;
    @Save
    private SidedInventoryComponent<SifterMachineTile> output;
    @Save
    private SidedFluidTankComponent<SifterMachineTile> outputFluid;
    @Nullable
    private SifterMachineRecipe currentRecipe;

    public SifterMachineTile(BlockPos blockPos, BlockState blockState) {
    ...
    protected EnergyStorageComponent<SifterMachineTile> createEnergyStorage() {
    ...
    @Nonnull
    public SifterMachineTile getSelf() {
        return this;
    }
}
