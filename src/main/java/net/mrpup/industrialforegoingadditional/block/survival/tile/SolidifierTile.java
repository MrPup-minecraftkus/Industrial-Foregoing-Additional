...
public class SolidifierTile extends IndustrialProcessingTile<SolidifierTile> {
    ...
    public boolean canIncrease() {
        return this.currentRecipe != null && ItemHandlerHelper.insertItem(this.output, currentRecipe.output.copy(), true).isEmpty();
    }
        ...
        return () -> {
            ...
            if (SolidifierRecipe != null) {
                if (SolidifierRecipe.inputFluid != null) {
                    ...
                    ItemStack outputStack = SolidifierRecipe.output.copy();
