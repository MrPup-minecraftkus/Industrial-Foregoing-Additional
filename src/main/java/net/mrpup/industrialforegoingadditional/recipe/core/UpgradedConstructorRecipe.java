...
public class UpgradedConstructorRecipe extends SerializableRecipe {
    ...
    public UpgradedConstructorRecipe(ResourceLocation resourceLocation) {
        super(resourceLocation);
    }

    public UpgradedConstructorRecipe(ResourceLocation resourceLocation, Ingredient.Value[] input, FluidStack inputFluid1, FluidStack inputFluid2, int processingTime, ItemStack output, FluidStack outputFluid) {
        super(resourceLocation);
        this.input = input;
    ...
    public GenericSerializer<? extends SerializableRecipe> getSerializer() {
        return (GenericSerializer<? extends SerializableRecipe>) ModuleCoreAdditional.UPGRADED_CONSTRUCTOR_SERIALIZER.get();
    }
